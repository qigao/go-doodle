...
func (o *Article) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to populate default values for articles")
	}
...
func (o *Article) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to upsert for articles")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entity: unable to retrieve unique values for articles")
	}
